...
BASE_SITE = "https://pornhd4k.net/"
SITE_HOST = "pornhd4k.net"
SITE_ALIASES = frozenset({"pornhd4k.net", "www.pornhd4k.net"})
...
def can_handle(host: str) -> bool:
    ...
    if h in SITE_ALIASES:
        return True
    return h.endswith(".pornhd4k.net")
