...
BASE_SITE = "https://yesporn.vip/"
SITE_HOST = "yesporn.vip"
SITE_ALIASES = frozenset({"yesporn.vip", "www.yesporn.vip"})
...
_VIDEO_HREF_RE = re.compile(
    r"yesporn\.vip/video/(?P<id>\d+)/(?P<slug>[^/?#]+)/?",
    re.IGNORECASE,
)
...
def parse_video_page(html: str, url: str) -> dict[str, Any]:
    ...
    model_link = soup.select_one(".video-holder a[href*='/models/']")
