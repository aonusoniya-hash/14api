...
EXPLORE_SOURCES = [
    ...
    ExploreSourceResponse(
        baseUrl="https://d2eabzntayzi4t.cloudfront.net/?category=2",
        nickname="爆奶视频",
        favicon="https://d2eabzntayzi4t.cloudfront.net/favicon.ico",
        accentColor="#FF4081",
        category="porn",
        isVerified=False,
        hasCategories=True,
        searchUrlTemplate="https://d2eabzntayzi4t.cloudfront.net/?search={query}",
        sourceId="baonai",
        disable=False,
        pageSize=20,
    ),
