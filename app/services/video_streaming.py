...
async def get_video_info(url: str, api_base_url: str = "http://localhost:8000") -> dict:
    ...
    elif whoreshub.can_handle(host):
        scraper_module = whoreshub
    else:
        raise HTTPException(
            status_code=400,
